...
**Institutional-grade investment research, without the institution.**
...
| Stage | Role |
|---|---|
| **Research** | Establishes the evidence base from structured company and financial data. |
...
| **Committee** | Adjudicates evidence, valuation, and asymmetry — does not average Bull and Bear. |
...
| **Bull and Bear are symmetric** | The Bear agent is instructed to actually try to kill the thesis, not to be a token counterpoint. |
